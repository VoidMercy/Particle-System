...
spiral_url  = "http://localhost:8000/images/spiral.png";

// Images to be loaded into PIXI
image_urls = [button_url, snowflake_url, raindrop_url, bee_url, play_url, pause_url, spiral_url];
...
var simulation_status = {
  ...
  "spiral":{running: false, run: add_spiral, button: spiral_url}
};
